...
# 🔥 БЕЗОПАСНОЕ ПОЛУЧЕНИЕ ТОКЕНА (НЕ КРАШИТ СБОРКУ VERCEL)
...
# ========== PTB & HANDLERS ==========
ptb_app = Application.builder().token(BOT_TOKEN or "BUILD_PLACEHOLDER").build()
...
# ========== ASGI ENTRY POINT (ВСЕГДА СОЗДАЁТСЯ, ДАЖЕ ПРИ СБОРКЕ) ==========
@asynccontextmanager
...
# 🔥 ТОЧКИ ВХОДА (БЕЗ УСЛОВИЙ И RAISE)
